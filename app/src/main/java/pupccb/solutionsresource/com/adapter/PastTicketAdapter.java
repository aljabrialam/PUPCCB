 ...
 */
public class PastTicketAdapter extends RecyclerView.Adapter<PastTicketAdapter.TicketViewHolder> {
    ...
    public PastTicketAdapter(Activity activity, List<TicketInfo> ticketInfoList) {
    ...
    public void onBindViewHolder(TicketViewHolder ticketViewHolder, int i) {
        ...
        ticketViewHolder.date.setText(checkDateTime(selectedItem.getDate()));
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        Log.d("CurrentTicketAdapter", "onActivityResult");
    }
